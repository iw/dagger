...
proptest! {
    ...
    fn property_23_packaged_assets_public_dependencies_closed_graph(
        ...
        if dependency_shape == 1 {
            let valid = registry_dependency("1.0.0-beta.11.rust.4", "dagger-sdk");
        ...
        let dependency = match dependency_shape {
            0 => registry_dependency("1.0.0-beta.11.rust.4", "dagger-sdk"),
...
fn package_identity(seed: u8, fork: bool) -> PackageIdentity {
    ...
    let sdk_dependency = if fork {
        ...
        registry_dependency("1.0.0-beta.11.rust.4", "dagger-sdk")
    };
    PackageIdentity {
        repository,
        dagger_revision,
        engine_version: value("1.0.0-beta.11.rust.4"),
        rust_sdk_version: value("1.0.0-beta.11.rust.4"),
