...
mod tests {
    ...
    fn hook_baseline_migration_requires_exact_authenticated_identity() {
        ...
        let previous = OperationManifest {
            ...
            post_work: Vec::new(),
            generator: GeneratorIdentity {
                version: exact("1.0.0-beta.11.rust.2"),
    ...
    fn target() -> TargetIdentity {
        TargetIdentity {
            ...
            engine_version: exact("1.0.0-beta.11.rust.2"),
            rust_sdk_version: exact("1.0.0-beta.11.rust.2"),
    ...
    fn dependency() -> PublishedSdkDependency {
        PublishedSdkDependency::Registry {
            ...
            exact_version: exact("1.0.0-beta.11.rust.2"),
        }
    }
