...
crates.io. Download `dagger-sdk-1.0.0-beta.11.rust.2.crate`,
`dagger-sdk-macros-1.0.0-beta.11.rust.2.crate`, and `SHA256SUMS` from the same manual
...
tar -xzf dagger-sdk-1.0.0-beta.11.rust.2.crate -C vendor/dagger-sdk --strip-components=1
tar -xzf dagger-sdk-macros-1.0.0-beta.11.rust.2.crate -C vendor/dagger-sdk-macros --strip-components=1
```
