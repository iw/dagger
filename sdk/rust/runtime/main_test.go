...
func TestGenerationRequestKeepsAuthoringSemanticsInRust(t *testing.T) {
	descriptor := metadata.EngineSource{
		...
		EngineVersion:    "1.0.0-beta.11.rust.2",
		RustSDKVersion:   "1.0.0-beta.11.rust.2",
		...
		SDKDependency: metadata.PublishedSDKDependency{
			...
			Registry:     "crates-io",
			Package:      "dagger-sdk",
			ExactVersion: "1.0.0-beta.11.rust.2",
		},
	}
...
func TestProperty19ModernLegacyGenerationSemanticallyConverge(t *testing.T) {
	descriptor := metadata.EngineSource{
		...
		DaggerRevision: strings.Repeat("a", 40), EngineVersion: "1.0.0-beta.11.rust.2",
		RustSDKVersion: "1.0.0-beta.11.rust.2", RustToolchain: "1.97.1",
		CoreSchemaDigest: "sha256:" + strings.Repeat("b", 64),
		SDKDependency: metadata.PublishedSDKDependency{
			Source: "registry", Registry: "crates-io", Package: "dagger-sdk", ExactVersion: "1.0.0-beta.11.rust.2",
		},
	}
